...
namespace Pras.Infrastructure.Identity.Extensions
{
    ...
    public static class IdentityExtensions
    {
        ...
        {
            var errors = Mapper.Map<List<ApplicationIdentityError>>(identityResult.Errors);
            return identityResult == null ? null : new ApplicationIdentityResult(errors, identityResult.Succeeded);
        }
        ...
        public static ApplicationUser CopyAppUserProperties(this ApplicationUser applicationIdentityUser, AppUser appUser)
        {
            if (appUser == null)
            {
                return null;
            ...
            applicationIdentityUser.LockoutEnd = appUser.LockoutEnd;
        ...
        public static AppUser ToAppUser(this ApplicationUser applicationIdentityUser)
        {
            if (applicationIdentityUser == null)
            {
                return null;
        ...
        public static AppUser CopyApplicationIdentityUserProperties(this AppUser appUser, ApplicationUser applicationIdentityUser)
        {
            if (appUser == null)
            {
                return null;
            ...
            appUser.LockoutEnd = applicationIdentityUser.LockoutEnd;
        ...
        public static ApplicationUserRole ToApplicationUserRole(this IdentityUserRole<Guid> role)
        {
            return role == null ? null : new ApplicationUserRole { RoleId = role.RoleId, UserId = role.UserId };
        }

        //public static ApplicationIdentityUserRole ToIdentityUserRole(this IdentityRole role)
        //{
        ...
        public static ApplicationExternalLoginInfo ToApplicationExternalLoginInfo(this ExternalLoginInfo externalLoginInfo)
        {
            return externalLoginInfo == null
                ? null
                : new ApplicationExternalLoginInfo
                {
                    ProviderDisplayName = externalLoginInfo.ProviderDisplayName,
                    ProviderKey = externalLoginInfo.ProviderKey,
                    LoginProvider = externalLoginInfo.LoginProvider,
                    Principal = externalLoginInfo.Principal,
                    AuthenticationTokens = externalLoginInfo.AuthenticationTokens
                };
        }

        public static ExternalLoginInfo ToExternalLoginInfo(this ApplicationExternalLoginInfo externalLoginInfo)
        {
            return externalLoginInfo == null ? null : new ExternalLoginInfo(externalLoginInfo.Principal, externalLoginInfo.LoginProvider, externalLoginInfo.ProviderKey, externalLoginInfo.ProviderDisplayName) {
                AuthenticationTokens = externalLoginInfo.AuthenticationTokens
            };
        }
        ...
        public static UserLoginInfo ToUserLoginInfo(this ApplicationUserLoginInfo loginInfo)
        {
            return loginInfo == null
                ? null
                : new UserLoginInfo(loginInfo.LoginProvider, loginInfo.ProviderKey, loginInfo.DisplayName);
        }

        public static ApplicationUserLoginInfo ToApplicationUserLoginInfo(this UserLoginInfo loginInfo)
        {
            return loginInfo == null ? null : new ApplicationUserLoginInfo(loginInfo.LoginProvider, loginInfo.ProviderKey, loginInfo.ProviderDisplayName);
        }
        ...
        //public static IEnumerable<ApplicationUserRole> ToApplicationUserRoleList(this IEnumerable<IdentityUserRole<Guid>> list)
        //{
        //    return list.Select(u => u.ToApplicationUserRole()).ToList();
        //}

        //public static IEnumerable<IdentityUserRole<Guid>> ToIdentityUserRoleList(this IEnumerable<ApplicationUserRole> list)
        //{
        ...
        //public static IEnumerable<ApplicationUser> ToApplicationUserList(this IEnumerable<AppUser> list)
        //{
        //    return list.Select(u => u.ToApplicationUser()).ToList();
        //}

        //public static IEnumerable<AppUser> ToAppUserList(this IEnumerable<ApplicationUser> list)
        //{
