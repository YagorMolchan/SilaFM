...
(function ($) {
    ...
    methods = {
        ...
        name: function(firstName, middleName, lastName) {
            return $(this).val($.transliterate($(firstName).val()) + "-" + $.transliterate($(middleName).val()) + "-" + $.transliterate($(lastName).val()));
        },
        unwatch: function () {
            return this.each(function () {
    ...
    $.transliterate = function (string) {
        ...
        string = string.replace(/[^a-zа-яёўі0-9]/gi, " ");
        string = string.replace(/ {2,}/gi, " ");
        string = string.trim();
        return string.replace(/([а-яёўі ])/gi, function (matchResult) {
