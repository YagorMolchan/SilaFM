...
function calc_proces(string) {
    ...
    if (tl.value && tl.value != 0) {
        ...
        if (parseInt(duration) == parseInt(time_limit)) {
            document.getElementById('hrono_normal').style.color = 'inherit';
        ...
        document.getElementById('min_hro').style.display = 'initial';
        document.getElementById('comf').style.display = 'initial';
    ...
    if (spare_words > 0) {
        ...
        if (spare_words > 0) {
            document.getElementById('sp_words_div').style.display = 'initial';
            document.getElementById('free_words_div').style.display = 'none';
        }
        ...
        if (free_words > 0) {
            document.getElementById('free_words_div').style.display = 'initial';
            document.getElementById('sp_words_div').style.display = 'none';
        }
        else {
            document.getElementById('free_words_div').style.display = 'none';
