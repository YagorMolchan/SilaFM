...
using Pras.Web.Controllers;
using Pras.Web.Extensions;
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<IActionResult> Login(LoginViewModel model, string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                var result = await _userManager.PasswordSignInAsync(model.Email, model.Password, model.RememberMe, lockoutOnFailure: false);
        ...
        //    var user = await _userManager.GetTwoFactorAuthenticationUserAsync();
        ...
        //    var result = await _userManager.TwoFactorAuthenticatorSignInAsync(authenticatorCode, rememberMe, model.RememberMachine);
        ...
        //    var result = await _userManager.TwoFactorRecoveryCodeSignInAsync(recoveryCode);
        ...
        //    var result = await _userManager.ExternalLoginSignInAsync(info.LoginProvider, info.ProviderKey, isPersistent: false, bypassTwoFactor: true);
        //    if (result.Succeeded)
        //    {
